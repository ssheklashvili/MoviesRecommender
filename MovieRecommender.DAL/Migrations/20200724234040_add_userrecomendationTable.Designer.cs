...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieRecommender.Core.Models.Entities.UserRecomendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MovieRecommender.Core.Models.Entities.UserRecomendationToMovie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("UserRecomendationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserRecomendationId");

                    b.ToTable("UserRecomendationToMovies");
                });
            ...
            modelBuilder.Entity("MovieRecommender.Core.Models.Entities.UserRecomendationToMovie", b =>
                {
                    b.HasOne("MovieRecommender.Core.Models.Movie", "Movie")
                        .WithMany("UserRecomendations")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieRecommender.Core.Models.Entities.UserRecomendation", "UserRecomendation")
                        .WithMany("UserRecomendationMovies")
                        .HasForeignKey("UserRecomendationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
